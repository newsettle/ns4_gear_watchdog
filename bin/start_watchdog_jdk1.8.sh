...
#设置jdk
export JAVA_HOME=$PWD/watchdog/env/jdk1.8.0_121
...
nohup $JAVA_HOME/bin/java $JVM_OPTS -classpath $CLASS_PATH com.creditease.ns4.gear.watchdog.monitor.WatchdogServer >$PWD/log/stdout.log 2>&1 &